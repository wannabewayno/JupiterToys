...
test.describe('Contact Page', () => {
  /*
    for all tests, have the user get to the contact page from the Home page.
  */
   ...
   */
  test("Navigate to Contact and test Mandatory form fields", async ({ contactPage }) => {
  ...
  for (let attempts = 1; attempts <= maxAttempts; attempts++) {
    test(`Navigate to Contact and test successful form submission ${attempts}/${maxAttempts}`, async ({ contactPage }) => {
